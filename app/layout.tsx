        ...
        <footer className="bg-desert/30 border-t border-desert/50 mt-16 sm:mt-20 lg:mt-24 relative overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-10 lg:gap-12">
              ...
              <div>
                <h4 className="text-base sm:text-lg font-heading font-semibold mb-3 sm:mb-4 text-text">Resources</h4>
                <ul className="space-y-2 sm:space-y-3 text-sm sm:text-base">
                  ...
                  <li>
                    <Link href="/grants" className="text-text-secondary hover:text-pine transition-colors inline-block py-1 min-h-[44px] flex items-center">
                      Grants
                    </Link>
                  </li>
                </ul>
              ...
              <div>
                <h4 className="text-base sm:text-lg font-heading font-semibold mb-3 sm:mb-4 text-text">Learn More</h4>
                <ul className="space-y-2 sm:space-y-3 text-sm sm:text-base">
                  <li>
                    <Link href="/guides" className="text-text-secondary hover:text-pine transition-colors inline-block py-1 min-h-[44px] flex items-center">
                      Resource Guides
                    </Link>
                  </li>
                  <li>
                    <Link href="/faq" className="text-text-secondary hover:text-pine transition-colors inline-block py-1 min-h-[44px] flex items-center">
                      FAQs
                    </Link>
                  </li>
                  <li>
                    <Link href="/blog" className="text-text-secondary hover:text-pine transition-colors inline-block py-1 min-h-[44px] flex items-center">
                      News & Updates
                    </Link>
                  </li>
                  <li>
                    <Link href="/stories" className="text-text-secondary hover:text-pine transition-colors inline-block py-1 min-h-[44px] flex items-center">
                      Success Stories
                    </Link>
                  </li>
                </ul>
              ...
              <div>
                <h4 className="text-base sm:text-lg font-heading font-semibold mb-3 sm:mb-4 text-text">Company</h4>
                <ul className="space-y-2 sm:space-y-3 text-sm sm:text-base">
                  <li>
                    <Link href="/about" className="text-text-secondary hover:text-pine transition-colors inline-block py-1 min-h-[44px] flex items-center">
                      About Us
                    </Link>
                  </li>
                  <li>
                    <Link href="/contact" className="text-text-secondary hover:text-pine transition-colors inline-block py-1 min-h-[44px] flex items-center">
                      Contact
                    </Link>
                  </li>
                  <li>
                    <Link href="/privacy" className="text-text-secondary hover:text-pine transition-colors inline-block py-1 min-h-[44px] flex items-center">
                      Privacy Policy
                    </Link>
                  </li>
                  <li>
                    <Link href="/terms" className="text-text-secondary hover:text-pine transition-colors inline-block py-1 min-h-[44px] flex items-center">
                      Terms of Service
                    </Link>
                  </li>
                </ul>
