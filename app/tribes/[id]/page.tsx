...
export default async function TribeDetailPage({
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      {/* Tribe Header */}
      <div className="bg-white rounded-earth-lg shadow-card p-8 mb-8 border border-desert/40">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
          {tribe.enrollmentOffice && (
            <div>
              <h3 className="font-semibold text-text mb-2">Enrollment Office</h3>
              <p className="text-text-secondary">{tribe.enrollmentOffice}</p>
            </div>
          )}
        </div>
        ...
        {tribe.languageLinks.length > 0 && (
          <div className="mb-6">
            <h3 className="font-semibold text-text mb-2">Language Resources</h3>
        ...
        {tribe.website && (
          <div className="mb-6">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-block px-6 py-3 bg-pine text-white rounded-earth font-medium hover:bg-pine-dark transition-colors"
            >
      ...
      {tribe.programs.length === 0 && (
        <div className="text-center py-12 bg-white rounded-earth-lg shadow-card">
